...
## Project Structure
    ...
    ├── testapiautostoryboa_80604  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_80604`
...
2. Clone this repo and `cd testapiautostoryboa_80604`
